<?php
	...
	$db2 = "SELECT Package_Name, Package_Price FROM package WHERE Package_Type = 'WeddingPlanning'";
...
<html>
	...
	<body>
		...
		<legend><b> Booking </b></legend>
			<img class=image src="images/wedp.png">
		...
		<form action="booking.php"  class="content" method="post">
			  ...
			  <div class="form-inputs">
				...
				<input type="text" class="frminput" id="name" name="visitor_name" placeholder="Lukas Mair"  required value="<?php echo $userName; ?>" >
			  </div>
			  
			  <div class="form-inputs">
				<label for="email">Your E-mail</label>
				<input type="email" class="frminput" id="email" name="visitor_email" placeholder="lukas.mair@hotmail.com"  value="<?php echo $EMAIL; ?>" required>
			  </div>
			  
			  <div class="form-inputs">
				<label for="phone">Your Phone</label>
				<input type="tel" class="frminput" id="phone" name="visitor_phone" placeholder="07X-XXX-XXXX"  value="<?php echo $PHONE; ?>" required>
			  </div>
			  ...
			  <div class="form-inputs">
				...
				<!--<input type="pkg" class="frminput" id="wedpkg1" name="selected_pkg" placeholder="Silver Package" required>-->
