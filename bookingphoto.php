<?php
	...
	$db2 = "SELECT Package_Name, Package_Price FROM package WHERE Package_Type = 'Photography'";
...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="styles/bookingphoto.css">
	...
	<body>
		...
		<div align="center">
		<center> <h2 style="color:#AB0552; font-size: 40px; font-family:Calibri" > Wedding Photography Packages </h2></center>
		</div>
		
		<div><fieldset style="border: 2px solid black;">
		
		<legend><b> Booking </b></legend>
			<img class=image src="images/wp.png">
